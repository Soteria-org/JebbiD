...
4. Trouble signing in? Contact **zeal247invest@gmail.com** — every failed sign-in attempt is logged and visible to staff, and most account-setup problems now fix themselves automatically the next time you try to sign in.
