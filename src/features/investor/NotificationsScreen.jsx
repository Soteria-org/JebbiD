...
import { ArrowUpRight, Award, Banknote, Bell, CheckCircle2, Clock, XCircle } from "@/components/icons/index";
...
export function NotificationsScreen({ ctx }) {
  ...
  const iconFor = {
    deposit_submitted: Clock, deposit_awaiting_review: Clock, investment_activated: CheckCircle2,
    deposit_rejected: XCircle, withdrawal_submitted: ArrowUpRight, withdrawal_request: ArrowUpRight,
    withdrawal_approved: CheckCircle2, withdrawal_rejected: XCircle, withdrawal_paid: Banknote,
    investment_matured: Award,
  };
  return (
