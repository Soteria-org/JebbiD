    ...
    <div className="jbd-login-shell" style={{ minHeight: "100vh", display: "flex", background: C.pageBg, fontFamily: FONT_BODY }}>
      ...
      <div className="jbd-login-promo" style={{ flex: 1, background: "radial-gradient(circle at 18% 12%, " + C.brand + ", " + C.brandDark + " 62%)",
        ...
        <div style={{ position: "relative" }}>
          ...
          <div className="jbd-login-headline" style={{ fontFamily: FONT_DISPLAY, fontSize: 36, fontWeight: 500, lineHeight: 1.22, marginBottom: 18, color: C.white, maxWidth: 440 }}>
            Small, consistent investments build great wealth.
          </div>
          <div className="jbd-login-rule" style={{ height: 1, width: 64, background: C.gold, margin: "24px 0" }} />
          <div className="jbd-login-desc" style={{ fontSize: 14, color: C.sidebarText, lineHeight: 1.65, maxWidth: 400 }}>
        ...
        <div className="jbd-login-stats" style={{ position: "relative", display: "flex", gap: 28, flexWrap: "wrap" }}>
